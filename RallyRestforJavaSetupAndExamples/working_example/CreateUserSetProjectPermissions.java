...
public class CreateUserSetProjectPermissions {
    ...
    // public String apiKey   = cfg.getProperty("apikey");
    // public String host = cfg.getProperty("host");
    // public String applicationName = cfg.getProperty("applicationName") + ":create user and projectpermissions";
    ...
    public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException {
        ...
        String applicationName =  "Adil :create user and projectpermissions";
        
        
        RallyRestApi restApi = new RallyRestApi(new URI(host), apiKey);
        restApi.setApplicationName(applicationName);
        String workspaceRef = "/workspace/18686460954"; 
